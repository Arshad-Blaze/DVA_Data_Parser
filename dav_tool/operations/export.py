"""Export Operation — write canonical data to CSV, Parquet, or Excel.

Supports exporting any intermediate result.  Configuration driven.
"""
...
class ExportOptions(OperationOptions):
    ...
    format: str = "csv"  # csv, parquet, excel
    include_header: bool = True
    separator: str = ","  # for CSV


class ExportOperation(IDataOperation):
    """Export a DataFrame to CSV, Parquet, or Excel."""
