"""Aggregate Operation — group-by and aggregation on canonical data.

Supports SUM, COUNT, AVG, MIN, MAX, FIRST, LAST on any columns.
Configuration driven — no retailer-specific logic.
"""
...
class AggregateOptions(OperationOptions):
    ...
    # aggregations maps column_name -> function_name (e.g. {"Units": "sum"})


class AggregateOperation(IDataOperation):
    """Group-by aggregation — the core data operation."""
