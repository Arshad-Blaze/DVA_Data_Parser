"""Filter Operation — row filtering on canonical data.

Supports equals, contains, startswith, endswith, gt, lt, gte, lte,
in_list, null, not_null.  Configuration driven.
"""
...
class FilterCondition:
    ...
    column: str
    operator: str  # eq, contains, startswith, endswith, gt, lt, gte, lte, in_list, null, not_null
    value: Any = None
...
class FilterOperation(IDataOperation):
    """Row filtering — equals, contains, ranges, nulls, etc."""
