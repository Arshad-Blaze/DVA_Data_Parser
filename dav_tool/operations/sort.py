"""Sort Operation — multi-column sorting on canonical data.

Supports ascending/descending and stable sorting.  Configuration driven.
"""
...
class SortOperation(IDataOperation):
    """Multi-column sort with ascending/descending support."""
